"""
train.py — Training loop for the CNN baseline.

Mirrors YOLO26 training configuration:
...
Results CSV columns match YOLO's results.csv exactly:
...
def train(
    ...
    """
    Full training run. Returns list of per-epoch metric dicts.
