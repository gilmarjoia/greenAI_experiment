"""
run.py — Entry point for the CNN baseline experiment.
...
Mirrors the YOLO26 / Transformers baseline experiment structure exactly:
  - 10 epochs, batch=16, SGD lr=0.01, warmup 3 epochs, cosine decay
  - Outputs land in  cnn_baseline/output/runs/train/
...
def main():
    print("=" * 60)
    print("CNN Baseline — Fashion-MNIST Classification")
    print("=" * 60)
    ...
    tracker = EmissionsTracker(
        project_name="cnn_baseline_training",
