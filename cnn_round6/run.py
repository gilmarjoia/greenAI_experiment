"""
run.py — Entry point for the CNN Round 6 experiment.
...
Round 6 — 30 Epoch Baseline:
  - 30 epochs, batch=16, SGD lr=0.01, warmup 3 epochs, cosine decay
  - Same hyperparameters as baseline (Round 1), only epochs increased to 30
  - Outputs land in  cnn_round6/output/runs/train/
  - CodeCarbon log   cnn_round6/output/emissions.csv
"""
...
def main():
    print("=" * 60)
    print("CNN Round 6 — Fashion-MNIST Classification")
    print("=" * 60)
    ...
    tracker = EmissionsTracker(
        project_name="cnn_round6_training",
