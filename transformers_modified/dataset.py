"""
dataset.py — Fashion-MNIST loader for transformers_modified.

Extends transformers_baseline/dataset.py with stronger training-time augmentation
to address the overfitting observed (train loss 0.021 vs val loss 0.184).
