"""
run.py — Entry point for the CNN Round 5 experiment.
...
Mirrors the YOLO26 / Transformers Round 5 experiment structure exactly:
  - 20 epochs, batch=16, SGD lr=0.01, warmup 3 epochs, cosine decay
  - Outputs land in  cnn_round5/output/runs/train/
  - CodeCarbon log   cnn_round5/output/emissions.csv
"""
...
def main():
    print("=" * 60)
    print("CNN Round 5 — Fashion-MNIST Classification")
    print("=" * 60)
    ...
    tracker = EmissionsTracker(
        project_name="cnn_round5_training",
