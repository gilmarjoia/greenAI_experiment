"""
plots.py — Generate training artifacts for transformers_round3.
Identical to transformers_modified/plots.py — only the chart title is updated.
...
def plot_results(results: list[dict], save_dir: Path) -> None:
    ...
    fig.suptitle("ViT Round 4 — Training Results", fontsize=13, fontweight="bold")
