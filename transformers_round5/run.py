"""
run.py — Entry point for the Transformers Round 5 experiment.
...
Mirrors the YOLO26 / CNN baseline experiment structure exactly but with 20 epochs:
  - 20 epochs, batch=16, AdamW lr=1e-4, warmup 3 epochs, cosine decay
  - Outputs land in  transformers_round5/output/runs/train/
  - CodeCarbon log   transformers_round5/output/emissions.csv
"""
...
def main():
    ...
    tracker = EmissionsTracker(
        project_name="transformers_round5_training",
