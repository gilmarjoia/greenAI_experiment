"""
train.py — Training loop for cnn_modified.
...
Changes vs cnn_baseline:
  ...
  - All other logic (SGD + Nesterov, cosine LR decay, AMP, CSV logging) is
    identical to cnn_baseline so results remain directly comparable.
"""
