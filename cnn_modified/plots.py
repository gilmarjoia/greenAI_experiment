"""
plots.py — Generate training artifacts for cnn_modified.
Identical to cnn_baseline/plots.py — only the chart title is updated.
...
def plot_results(results: list[dict], save_dir: Path) -> None:
    ...
    fig.suptitle("CNN Modified — Training Results", fontsize=13, fontweight="bold")
