"""
model.py — Simple CNN for cnn_modified (same architecture as cnn_baseline).
...
In cnn_modified it is set to 0.3 (vs 0.0 in cnn_baseline) to address overfitting.
"""
import torch
...
class SimpleCNN(nn.Module):
    ...
    def __init__(self, num_classes: int = 10, dropout: float = 0.0):
        ...
        # Classifier — dropout raised to 0.3 in cnn_modified to reduce overfitting
