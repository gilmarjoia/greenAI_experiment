"""
dataset.py — Fashion-MNIST loader for cnn_modified.

Extends the baseline dataset.py with training-time augmentation to address
the overfitting observed in cnn_baseline (train loss 0.042 vs val loss 0.208).
